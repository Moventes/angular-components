(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('google-libphonenumber'), require('rxjs/Observable'), require('rxjs/observable/of')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'google-libphonenumber', 'rxjs/Observable', 'rxjs/observable/of'], factory) :
	(factory((global['mv-angular-components'] = {}),global['@angular/core'],global.ng.common,global.ng.forms,global['google-libphonenumber'],global.Rx,global.Rx.Observable));
}(this, (function (exports,core,common,forms,googleLibphonenumber,Observable,of) { 'use strict';

/**
 * Provides utils for phone numbers
 */
var PhoneNumberUtil$1 = googleLibphonenumber.PhoneNumberUtil;
/**
 * Provides the differents format used by Google's libphonenumber
 */
var PhoneNumberFormat$1 = googleLibphonenumber.PhoneNumberFormat;
/**
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return PhoneInputDirective; }),
                        multi: true
                    }
                ]
            },] },
...
PhoneInputDirective.propDecorators = {
    'input': [{ type: core.HostListener, args: ['input', ['$event.target.value'],] },],
};
/**
...
AddressInputDirective.decorators = [
    { type: core.Directive, args: [{
                ...
                providers: [
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return AddressInputDirective; }),
                        multi: true
                    }
                ]
            },] },
...
ErrorDisplayDirective.propDecorators = {
    'mvErrorDisplay': [{ type: core.Input },],
};
...
TranslateDirective = __decorate$6([
    ...
    __metadata$1("design:paramtypes", [TranslateService, core.ElementRef, core.ChangeDetectorRef])
], TranslateDirective);
...
TranslatePipe = __decorate$7([
    ...
    __metadata$2("design:paramtypes", [TranslateService, core.ChangeDetectorRef])
], TranslatePipe);
...
exports.ComponentesAngularModule = ComponentesAngularModule;
exports.ComponentesCommonModule = ComponentesCommonModule;
exports.ɵb = AddressInputDirective;
exports.ɵc = ErrorDisplayDirective;
exports.ɵa = PhoneInputDirective;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=mv-angular-components.umd.js.map

 ...
 */
const PhoneNumberUtil$1 = PhoneNumberUtil;
/**
 * Provides the differents format used by Google's libphonenumber
 */
const PhoneNumberFormat$1 = PhoneNumberFormat;
/**
...
class AddressInputDirective {
     ...
     */
    selectAddress() {
        const /** @type {?} */ place = this.autocomplete.getPlace();
        const /** @type {?} */ addressValue = {};
        const /** @type {?} */ addressDetails = {};
...
class ErrorDisplayDirective {
     ...
     * @param {?} renderer {Renderer2} Angular provider which aims to impact value on the DOM
     */
    constructor(templateRef, viewContainer, controlContainer, renderer) {
    ...
    updateErrorList(target) {
        ...
        if (this.target) {
            ...
            for (const /** @type {?} */ error in target.errors) {
                const /** @type {?} */ embeddedView = this.viewContainer.createEmbeddedView(this.templateRef, { $implicit: 'ERROR.' + this.target.toUpperCase() + '.' + error.toUpperCase() });
            }
        }
        else {
            // tslint:disable-next-line:forin
            for (const /** @type {?} */ control in target.control.controls) {
                ...
                for (const /** @type {?} */ error in target.control.get(control).errors) {
                    const /** @type {?} */ embeddedView = this.viewContainer.createEmbeddedView(this.templateRef, { $implicit: 'ERROR.' + control.toUpperCase() + '.' + error.toUpperCase() });
                }
            }
        }
    }
...
class ComponentesAngularModule {
}
...
export { ComponentesAngularModule, ComponentesCommonModule, AddressInputDirective as ɵb, ErrorDisplayDirective as ɵc, PhoneInputDirective as ɵa };
//# sourceMappingURL=mv-angular-components.js.map
